...
class BussinnesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $transportCarga     = BusinessType::where('label', 'transporte_de_carga')->first();
        $transportPasajeros = BusinessType::where('label', 'transporte_de_pasajeros')->first();
        $logistica          = BusinessType::where('label', 'logistica_y_distribucion')->first();
        $mensajeria         = BusinessType::where('label', 'servicios_de_mensajeria')->first();
        $mantenimiento      = BusinessType::where('label', 'mantenimiento_de_vehiculos')->first();
