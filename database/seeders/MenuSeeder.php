    ...
    public function run(): void
    {
        $sections = [
            ...
            [
                ...
                'behavior'         => 'collapsible',
                'permission'       => 'workshop.catalog.view',
                'sort_order'       => 50,
                'items'            => [
                    ['name' => 'Servicios', 'route_name' => 'admin.workshop.catalog.services.index', 'active_route_pattern' => 'admin.workshop.catalog.services.*', 'icon_svg_path' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', 'permission' => 'workshop.catalog.services.view', 'sort_order' => 10],
                    ['name' => 'Repuestos', 'route_name' => 'admin.workshop.catalog.spare-parts.index', 'active_route_pattern' => 'admin.workshop.catalog.spare-parts.*', 'icon_svg_path' => 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z', 'permission' => 'workshop.catalog.spare-parts.view', 'sort_order' => 20],
                ],
            ],
            [
                'slug'             => 'configuracion',
