    ...
    public function run(): void
    {
        $sections = [
            ...
            [
                ...
                'icon_color_class' => 'text-indigo-400',
                'route_patterns'   => ['admin.businesses.*', 'admin.business-types.*', 'admin.organization-types.*', 'admin.businesses.modules', 'admin.team-positions.*', 'admin.business-payment-methods.*', 'admin.business-bank-accounts.*'],
                'behavior'         => 'collapsible',
                'sort_order'       => 25,
                'items'            => [
                    [
