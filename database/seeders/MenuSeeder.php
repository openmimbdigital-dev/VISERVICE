    ...
    public function run(): void
    {
        $sections = [
            ...
            [
                'slug' => 'presentacion',
                'name' => 'Presentación',
                'icon_svg_path' => 'M12 14l9-5-9-5-9 5 9 5z | M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z',
                'icon_color_class' => 'text-indigo-400',
                'route_patterns' => [
                    'admin.presentation.academic.*',
                    'admin.presentation.reports.*',
                    'admin.presentation.enrollment.*',
                    'admin.presentation.events.*',
                    'admin.presentation.users.*',
                    'admin.presentation.roles.*',
                    'admin.presentation.billing.*',
                    'admin.presentation.parent-app.*',
                ],
                'behavior' => 'collapsible',
                'role' => 'superAdmin',
                'sort_order' => 22,
                'items' => [
                    [
                        'name' => 'Cursos',
                        'route_name' => 'admin.presentation.academic.courses.index',
                        'active_route_pattern' => 'admin.presentation.academic.courses.*',
                        'icon_svg_path' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253',
                        'role' => 'superAdmin',
                        'sort_order' => 10,
                    ],
                    [
                        'name' => 'Mi aula',
                        'route_name' => 'admin.presentation.academic.classroom.index',
                        'active_route_pattern' => 'admin.presentation.academic.classroom.*',
                    ...
                    [
                        'name' => 'Reportes',
                        'route_name' => 'admin.presentation.reports.index',
                        'active_route_pattern' => 'admin.presentation.reports.*',
                    ...
                    [
                        'name' => 'Inscripción',
                        'route_name' => 'admin.presentation.enrollment.index',
                        'active_route_pattern' => 'admin.presentation.enrollment.*',
                        'icon_svg_path' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
                        'role' => 'superAdmin',
                        'sort_order' => 40,
                    ],
                    [
                        'name' => 'Eventos',
                        'route_name' => 'admin.presentation.events.index',
                        'active_route_pattern' => 'admin.presentation.events.index|admin.presentation.events.create|admin.presentation.events.show',
                    ...
                    [
                        'name' => 'Agenda',
                        'route_name' => 'admin.presentation.events.schedule.index',
                        'active_route_pattern' => 'admin.presentation.events.schedule.*',
                        'icon_svg_path' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z',
                        'role' => 'superAdmin',
                        'sort_order' => 60,
                    ],
                    [
                        'name' => 'Usuarios',
                        'route_name' => 'admin.presentation.users.index',
                        'active_route_pattern' => 'admin.presentation.users.*',
                        'icon_svg_path' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z',
                        'role' => 'superAdmin',
                        'sort_order' => 70,
                    ],
                    [
                        'name' => 'Roles',
                        'route_name' => 'admin.presentation.roles.index',
                        'active_route_pattern' => 'admin.presentation.roles.*',
                        'icon_svg_path' => 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
                        'role' => 'superAdmin',
                        'sort_order' => 80,
                    ],
                    [
                        'name' => 'Facturación',
                        'route_name' => 'admin.presentation.billing.index',
                        'active_route_pattern' => 'admin.presentation.billing.*',
                        'icon_svg_path' => 'M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z',
                        'role' => 'superAdmin',
                        'sort_order' => 90,
                    ],
                    [
                        'name' => 'App de padres',
                        'route_name' => 'admin.presentation.parent-app.index',
                        'active_route_pattern' => 'admin.presentation.parent-app.*',
                        'icon_svg_path' => 'M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z',
                        'role' => 'superAdmin',
                        'sort_order' => 100,
                    ],
                ],
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'route_name' => 'admin.dian-settings.index',
                        'active_route_pattern' => 'admin.dian-settings.*',
                        'icon_svg_path' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
                        'permission' => 'dian_settings.view',
                        'sort_order' => 60,
                    ],
                ],
            ],
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'route_name' => 'admin.catalog.coupons.index',
                        'active_route_pattern' => 'admin.catalog.coupons.*',
                        'icon_svg_path' => 'M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z',
                        'permission' => 'catalog.coupons.view',
                        'sort_order' => 20,
                    ],
                ],
            ],
