    ...
    */
    ...
    'modules' => [
        ...
        'settings_event_categories' => [
            ...
            'permissions' => [
                'settings.event_categories.view' => 'Ver categorías de eventos',
                'settings.event_categories.create' => 'Crear categorías de eventos',
                'settings.event_categories.edit' => 'Editar categorías de eventos',
                'settings.event_categories.delete' => 'Eliminar categorías de eventos',
            ],
        ],
        'settings_attendee_types' => [
            'name' => 'Configuración — Tipos de asistente',
            'permissions' => [
                'settings.attendee_types.view' => 'Ver tipos de asistente',
                'settings.attendee_types.create' => 'Crear tipos de asistente',
                'settings.attendee_types.edit' => 'Editar tipos de asistente',
        ...
        'events_teams' => [
            ...
            'permissions' => [
                ...
                'events.teams.edit' => 'Editar equipos de evento',
                'events.teams.delete' => 'Eliminar equipos de evento',
            ],
        ],
        'events_team_roles' => [
            ...
            'permissions' => [
                ...
                'events.team_roles.edit' => 'Editar roles del equipo',
                'events.team_roles.delete' => 'Eliminar roles del equipo',
            ],
        ],
