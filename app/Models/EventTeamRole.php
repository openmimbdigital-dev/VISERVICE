...
class EventTeamRole extends Model
{
    use SoftDeletes;
    ...
    {
        return $this->belongsToMany(EventTeam::class, 'event_team_role')
            ->withTimestamps();
    }
    ...
    public function scopeForAuthUser(Builder $query, ?User $user = null): Builder
    {
        ...
        return $query->whereIn('event_team_roles.business_id', $business_ids);
    }

    public function hasDependencies(): bool
    {
        return $this->teams()->exists() || $this->members()->exists();
    }
    ...
    public function canDelete(?User $user = null): bool
    {
        ...
        if (! $user?->can('events.team_roles.delete')) {
            return false;
        }
