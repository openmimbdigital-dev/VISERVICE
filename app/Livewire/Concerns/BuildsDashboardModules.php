...
trait BuildsDashboardModules
{
    protected function dashboardModulesForPanel(string $panel = 'admin'): array
    {
        $sections = app(SidebarMenuBuilder::class)->build(auth()->user(), $panel);
