    ...
    public static function sections(): array
    {
        return [
            ...
            'models' => [
                ...
                'permission'           => 'settings.model_equipment.view',
            ...
            'attributes' => [
                'key'                  => 'attributes',
                'title'                => 'Atributos',
                'description'          => 'Campos personalizados por tipo de equipo (select, texto, número, etc.) para caracterizar equipos.',
                'button_text'          => 'Gestionar atributos',
                'create_button_text'   => 'Nuevo atributo',
                'route'                => 'admin.settings.equipment.attributes.index',
                'create_route'         => 'admin.settings.equipment.attributes.create',
                'permission'           => 'settings.attributes.view',
                'datatable_component'  => 'admin.settings.equipment.attributes.datatable-attributes',
