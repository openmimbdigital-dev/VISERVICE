    ...
    public static function sections(): array
    {
        return [
            'types' => [
                ...
                'route'                => 'admin.settings.catalog-products.product-types.index',
                'create_route'         => 'admin.settings.catalog-products.product-types.create',
                'permission'           => 'settings.product_types.view',
                'datatable_component'  => 'admin.settings.catalog.product-types.datatable-product-types',
            ...
            'categories' => [
                ...
                'route'                => 'admin.settings.catalog-products.product-categories.index',
                'create_route'         => 'admin.settings.catalog-products.product-categories.create',
                'permission'           => 'settings.product_categories.view',
                'datatable_component'  => 'admin.settings.catalog.product-categories.datatable-product-categories',
