                            ...
                            <tr wire:key="woi-{{ $item->id }}" class="transition hover:bg-slate-50/70">
                                ...
                                <td class="px-3 py-3 sm:px-4">
                                    <div class="flex flex-wrap justify-end gap-1">
                                        ...
                                        <button wire:click="deleteItem({{ $item->id }})" wire:confirm="¿Eliminar ítem?" type="button" class="rounded-lg p-1.5 text-slate-400 transition hover:bg-red-50 hover:text-red-600" title="Eliminar">
