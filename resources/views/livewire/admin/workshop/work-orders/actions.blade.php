@php
    $can_mutate = in_array($status, ['abierta', 'en_proceso'], true);
@endphp
<div class="flex flex-nowrap items-center justify-end gap-1">
    ...
    @else
    <button type="button" disabled title="Solo se pueden editar OTs abiertas o en proceso"
    ...
    <button type="button"
        ...
        @disabled(! $can_mutate)
        title="{{ $can_mutate ? 'Eliminar' : 'Solo se pueden eliminar OTs abiertas o en proceso' }}"
