<div class="relative mx-auto w-full max-w-[90rem] p-4 sm:p-6">
    ...
    <header class="mb-8">
        <div class="min-w-0 flex-1 border-l-4 border-indigo-600 pl-5">
            ...
            <h1 class="mt-2 text-2xl font-bold tracking-tight text-slate-900">General</h1>
            <p class="mt-2 max-w-xl text-sm text-slate-600">Parámetros globales del sistema. Solo disponibles para superAdmin.</p>
        </div>
    </header>
