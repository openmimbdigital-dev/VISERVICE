<div class="relative mx-auto w-full max-w-[90rem]">
    ...
    <header class="mb-8">
        <div class="min-w-0 flex-1 border-l-4 border-indigo-600 pl-5">
            ...
            <p class="mt-2 max-w-xl text-sm text-slate-600">Selecciona una sección para administrar el catálogo de equipos del taller.</p>
        </div>
    </header>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
        ...
        <article class="group flex min-h-[220px] flex-col rounded-2xl border p-5 shadow-sm ring-1 ring-slate-900/[0.035] transition-all hover:shadow-md {{ $section['card_bg'] }}">
            ...
            <div class="mt-auto pt-6">
                @php
                    $sectionRoute = $section['route'] ?? 'admin.settings.equipment.section';
                    $sectionParams = isset($section['route']) ? [] : [$section['key']];
                @endphp
                <a href="{{ route($sectionRoute, $sectionParams) }}" wire:navigate
