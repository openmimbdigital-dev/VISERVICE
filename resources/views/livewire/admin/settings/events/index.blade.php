<div class="relative mx-auto w-full max-w-[90rem] p-4 sm:p-6">
    ...
    <header class="mb-8">
        <div class="min-w-0 flex-1 border-l-4 border-indigo-600 pl-4 sm:pl-5">
            ...
            <p class="mt-2 max-w-xl text-sm text-slate-600">Administra las categorías de eventos y los tipos de asistentes de la iglesia.</p>
        </div>
    </header>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <article class="group flex min-h-[220px] flex-col rounded-2xl border p-5 shadow-sm ring-1 ring-slate-900/[0.035] transition-all hover:shadow-md {{ $section['card_bg'] }}">
            ...
            <div class="mt-auto pt-6">
                <a href="{{ route($section['route']) }}" wire:navigate class="btn {{ $section['btn_class'] }} btn-sm w-full justify-center">
                    {{ $section['button_text'] }}
                </a>
            </div>
        </article>
