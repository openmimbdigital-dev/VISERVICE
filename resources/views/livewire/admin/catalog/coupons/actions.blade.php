<div class="flex items-center gap-1">
    ...
    @else
    <button type="button" disabled title="Ya se usó en órdenes de trabajo: desactívalo en lugar de eliminarlo"
