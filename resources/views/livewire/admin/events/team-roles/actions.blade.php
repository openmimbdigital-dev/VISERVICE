<div class="flex flex-wrap justify-end gap-1">
    <a href="{{ route('admin.events.team-roles.show', $id) }}" wire:navigate title="Ver detalle"
    ...
    @can('events.team_roles.edit')
        @if($can_edit)
            <a href="{{ route('admin.events.team-roles.edit', $id) }}" wire:navigate title="Editar"
                class="rounded p-1.5 text-slate-400 transition-colors hover:bg-indigo-50 hover:text-indigo-600">
                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
