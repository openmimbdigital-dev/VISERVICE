<div class="relative mx-auto w-full max-w-[90rem] p-4 sm:p-6"
    ...
    <section class="mb-6 overflow-hidden rounded-2xl border border-slate-200/90 bg-white shadow-sm ring-1 ring-slate-900/[0.035]">
        <div class="border-b border-slate-100 bg-slate-50/80 px-5 py-4">
            ...
            <p class="mt-1 text-xs text-slate-500">Enlace abierto: muestra los datos del negocio y los módulos habilitados según el tipo de organización.</p>
        </div>
        <div class="grid grid-cols-1 gap-4 p-5 sm:p-6 lg:grid-cols-2">
            <div class="space-y-4">
                <p class="text-sm text-slate-600">
                    Quien abra este enlace verá el portal público sin PIN ni documento. Los módulos visibles dependen de la configuración por tipo de organización.
                </p>
