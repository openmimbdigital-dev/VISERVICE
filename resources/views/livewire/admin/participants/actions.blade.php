<div class="flex flex-wrap justify-end gap-1">
    ...
    <a href="{{ route('admin.participants.show', $id) }}" wire:navigate title="Ver participante"
    ...
    <a href="{{ route('admin.participants.form.edit', $id) }}" wire:navigate title="Editar participante"
    ...
    <button type="button" disabled
        title="No se puede eliminar: está siendo utilizado en otras referencias"
