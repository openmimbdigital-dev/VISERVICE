...
<head>
    ...
    <title>Iniciar Sesion - VISERVICE</title>
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div class="text-center">
                ...
                <h2 class="mt-6 text-3xl font-bold text-gray-900">VISERVICE</h2>
                <p class="mt-2 text-sm text-gray-600">Acceso al sistema</p>
            </div>
                ...
                <form class="space-y-6" method="POST" action="{{ route('login.attempt') }}">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                required
                                value="{{ old('username') }}"
                                class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 @error('username') border-red-500 @enderror"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <label for="remember" class="ml-2 block text-sm text-gray-700">Recordar sesion</label>
                        </div>
                    </div>
