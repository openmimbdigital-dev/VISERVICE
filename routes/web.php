...
use App\Livewire\Admin\Presentation\Academic\Classroom\ActivityForm as PresentationAcademicClassroomActivityForm;
use App\Livewire\Admin\Presentation\Academic\Classroom\ActivitySolve as PresentationAcademicClassroomActivitySolve;
use App\Livewire\Admin\Presentation\Academic\Classroom\Index as PresentationAcademicClassroomIndex;
use App\Livewire\Admin\Presentation\Academic\Classroom\Show as PresentationAcademicClassroomShow;
use App\Livewire\Admin\Presentation\Academic\Classroom\TypeIndex as PresentationAcademicClassroomTypeIndex;
use App\Livewire\Admin\Presentation\Academic\Courses\Index as PresentationAcademicCoursesIndex;
use App\Livewire\Admin\Presentation\Academic\Courses\Show as PresentationAcademicCoursesShow;
use App\Livewire\Admin\Presentation\Billing\ConceptsIndex as PresentationBillingConceptsIndex;
use App\Livewire\Admin\Presentation\Billing\Index as PresentationBillingIndex;
use App\Livewire\Admin\Presentation\Billing\InvoiceForm as PresentationBillingInvoiceForm;
use App\Livewire\Admin\Presentation\Billing\InvoicesIndex as PresentationBillingInvoicesIndex;
use App\Livewire\Admin\Presentation\Billing\InvoiceShow as PresentationBillingInvoiceShow;
use App\Livewire\Admin\Presentation\Billing\PaymentsIndex as PresentationBillingPaymentsIndex;
use App\Livewire\Admin\Presentation\Dashboard as PresentationDashboard;
use App\Livewire\Admin\Presentation\Enrollment\Form as PresentationEnrollmentForm;
use App\Livewire\Admin\Presentation\Enrollment\Index as PresentationEnrollmentIndex;
use App\Livewire\Admin\Presentation\Enrollment\Show as PresentationEnrollmentShow;
use App\Livewire\Admin\Presentation\Events\Form as PresentationEventsForm;
...
use App\Livewire\Admin\Presentation\Users\Show as PresentationUsersShow;
use App\Http\Controllers\Admin\Presentation\AcademicReportPdfController;
use App\Livewire\Admin\Presentation\Reports\CourseShow as PresentationReportsCourseShow;
use App\Livewire\Admin\Presentation\Reports\Index as PresentationReportsIndex;
use App\Livewire\Admin\Presentation\Reports\StudentShow as PresentationReportsStudentShow;
...
Route::middleware(['auth', 'ensure.business', 'business.module'])->group(function () {
    ...
    Route::middleware('role:superAdmin')->prefix('presentation')->name('admin.presentation.')->group(function () {
        Route::get('/', PresentationDashboard::class)->name('dashboard');
        Route::prefix('academic')->name('academic.')->group(function () {
            Route::get('/courses', PresentationAcademicCoursesIndex::class)->name('courses.index');
            Route::get('/courses/{course}', PresentationAcademicCoursesShow::class)->name('courses.show');
            Route::get('/classroom', PresentationAcademicClassroomIndex::class)->name('classroom.index');
            Route::get('/classroom/{subject}/activities/{type}/create', PresentationAcademicClassroomActivityForm::class)->name('classroom.activities.create');
            Route::get('/classroom/{subject}/activities/{type}/{activity}', PresentationAcademicClassroomActivitySolve::class)->name('classroom.activities.solve');
            Route::get('/classroom/{subject}/activities/{type}', PresentationAcademicClassroomTypeIndex::class)->name('classroom.activities.index');
            Route::get('/classroom/{subject}', PresentationAcademicClassroomShow::class)->name('classroom.show');
        });
        Route::get('/events', PresentationEventsIndex::class)->name('events.index');
        Route::get('/events/create', PresentationEventsForm::class)->name('events.create');
        Route::get('/events/schedule', PresentationEventsScheduleIndex::class)->name('events.schedule.index');
        Route::get('/events/{event}', PresentationEventsShow::class)->name('events.show');
        Route::get('/users', PresentationUsersIndex::class)->name('users.index');
        Route::get('/users/{user}', PresentationUsersShow::class)->name('users.show');
        Route::get('/roles', PresentationRolesIndex::class)->name('roles.index');
        Route::get('/roles/{role}', PresentationRolesShow::class)->name('roles.show');
        Route::prefix('billing')->name('billing.')->group(function () {
            Route::get('/', PresentationBillingIndex::class)->name('index');
            Route::get('/invoices', PresentationBillingInvoicesIndex::class)->name('invoices.index');
            Route::get('/invoices/create', PresentationBillingInvoiceForm::class)->name('invoices.create');
            Route::get('/invoices/{invoice}', PresentationBillingInvoiceShow::class)->name('invoices.show');
        ...
        Route::get('/reports/courses/{course}', PresentationReportsCourseShow::class)->name('reports.courses.show');
        Route::get('/reports/students/pdf', [AcademicReportPdfController::class, 'students'])->name('reports.students.pdf');
        Route::get('/reports/students/{student}/pdf', [AcademicReportPdfController::class, 'student'])->name('reports.students.pdf.show');
        Route::get('/reports/students/{student}', PresentationReportsStudentShow::class)->name('reports.students.show');
        Route::get('/enrollment', PresentationEnrollmentIndex::class)->name('enrollment.index');
        Route::get('/enrollment/create', PresentationEnrollmentForm::class)->name('enrollment.create');
        Route::get('/enrollment/{enrollment}', PresentationEnrollmentShow::class)->name('enrollment.show');
    });
